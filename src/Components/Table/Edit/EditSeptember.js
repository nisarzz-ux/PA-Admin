...
function FormSeptember(props){
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:8000/api/september_show/' + props.match.params.id)
        .then(response => {
    ...
    axios.put('http://127.0.0.1:8000/api/septemberTabel/update/'+ props.match.params.id, TabelSeptember)
    .then
       (res => {
           console.log(res)
           swal({
