...
function FormOktober(props){
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:8000/api/oktoberTabel/' + props.match.params.id)
        .then(response => {
    ...
    axios.put('http://127.0.0.1:8000/api/oktoberTabel/update/'+ props.match.params.id, TabelOktober)
    .then
       (res => {
           console.log(res)
           swal({
