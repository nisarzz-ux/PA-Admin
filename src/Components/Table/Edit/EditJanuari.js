...
function FormJanuari(props){
    ...
    useEffect(() => {
        axios.get('http://127.0.0.1:8000/api/januariTabel/' + props.match.params.id)
        .then(response => {
    ...
    axios.put('http://127.0.0.1:8000/api/januariTabel/update/'+ props.match.params.id, TabelJanuari)
    .then
       (res => {
           console.log(res)
           swal({
