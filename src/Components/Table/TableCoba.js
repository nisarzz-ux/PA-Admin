...
const [posts, setPosts] = useState([]);
  ...
  return (
    <Box>    
        <AppBar position="static">
          <Toolbar>
            ...
            <Button onClick={() => history.push('/TableNovember')} variant="contained" color="warning" size='small' 
            sx ={{marginRight:1}}>
                Previous
              </Button>
            
            <Button onClick={() => history.push('/TableDesember')} variant="contained" color="secondary" size='small' 
            sx ={{marginRight:1}}>
                Next
              </Button>
    ...
    >
      Rekapan Pesebaran Covid-19 Bulan Desember
      </Typography>
    ...
    <TableContainer component={Paper} className={classes.tableContainer}>
      <Table aria-label="simple table">
        <TableHead>
          <TableRow>
            <TableCell className={classes.tableCell}>Kode Barang</TableCell>
            <TableCell align="center" className={classes.tableCell}>Nama Barang</TableCell>
            <TableCell align="center"className={classes.tableCell}>Jumlah Barang</TableCell>
            <TableCell align="center" className={classes.tableCell}>Created At</TableCell>
            <TableCell align="center" className={classes.tableCell}>Update At</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
